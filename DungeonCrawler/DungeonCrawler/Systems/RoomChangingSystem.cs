    ...
    public class RoomChangingSystem
    {
        ...
        public void ChangeRoom(Door door)
        {
            ...
            ThreadStart threadStarter = delegate
            {
                ...
                if (door.DestinationRoom == "TestDungeon1" && game.RoomComponent[lastRoomEid].roomName == "TestDungeon3" && game.QuestLogSystem.currentQuest.questID == 0 && game.QuestLogSystem.currentQuest.questStatus == QuestStatus.InProgress)
                {
