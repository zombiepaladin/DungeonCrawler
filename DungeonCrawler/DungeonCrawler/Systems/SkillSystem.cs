...
// Modified by Adam Clark: cyborg skill added
// Modified by Nick Boen: Updated the Update() method 
//                        for chanceToSucceed components
// 
        ...
        public void EnemyUseSkill(SkillType skillType, uint callerID, uint targetID)
        {
            ...
            switch (skillType) //add in any skills you need an enemy to use
            {
                case SkillType.DamagingPull:
                    ...
                    //These should be here, that way we're not throwing away 
                    //entity id's that we could use if another skill is used
                    //that doesn't need all three of these id's 
                    // ~Nick B.
